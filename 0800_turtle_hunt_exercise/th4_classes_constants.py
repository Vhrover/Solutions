...
class Player(turtle.Turtle):
    ...
    def rotate_hunter(self, positions):  # turtle will be turned right <degree> degrees. Use negative values for left turns.
        ...
        # self.orientation %= 360
        # print(self.orientation)
        prey_direction = direction(self.position(), positions[0])
        # print(prey_direction)
...
class1 = Player  # (red prey) Replace PlayerName1 by your own class name here.
class2 = Player  # (green prey) For testing your code, replace PlayerName1 by your own class name here. Later replace this by your sparring partner's class name.
